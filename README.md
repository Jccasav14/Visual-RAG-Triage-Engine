...
An enterprise-grade, multimodal **Visual-RAG (Retrieval-Augmented Generation) Postoperative Telemedicine & Clinical Triage Ecosystem**. It is designed to assist surgical teams and discharged post-op patients in monitoring wound healing, detecting surgical site complications early (dehiscence, infection, seroma, hematoma), and delivering personalized, day-by-day medical recovery directives.
...
4. **Patient Telemedicine Companion (Mobile App & Web)**:
...
| **Mobile Application** | React Native, Expo SDK 50+ | `8081` | [`/mobile`](./mobile/README.md) | Patient & surgeon cross-platform mobile client with camera capture, offline PDF export, and biometric UX. |
...
| :--- | :--- | :--- | :--- | :--- |
| **👨‍⚕️ Surgeon (Doctor)** | `jeancasaxd60@gmail.com` | `password` | Dr. Jean Carlos Casa | `+593 99 876 5432` / `Dra. Elena Casa (0991122334)` |
| **👨‍⚕️ Surgeon (Doctor 2)** | `dr.silva@hospital.com` | `password` | Dr. Alejandro Silva | `+593 98 765 4321` / `Dr. Roberto Mendoza (0984455667)` |
